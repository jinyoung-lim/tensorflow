...
def floortype_classifier_model_fn(features, labels, mode):
    ...
    h, w, d = getImageShape()
    input_layer = tf.reshape(features["input"], [-1, IMAGE_SIZE, IMAGE_SIZE, d], name="input")
...
def test(test_data, model):
    ...
    for i, data in enumerate(test_data):
        ...
        # cv2.rectangle(
        #     img=image,
        #     pt1=(text_y-int(text_size[1]/2), text_x-int(text_size[0]/2)),
        #     pt2=(text_y+int(text_size[1]/2), text_x+int(text_size[0]/2)),
        #     color=(0, 0, 0),
